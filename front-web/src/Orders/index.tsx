...
function Orders() {
    ...
    const handleSelectProduct = (product: Product) => {
        const isAlreadySelected = checkIsSeleceted(selectedProducts, product)
    ...
    const handleSubmit = () => {
        ...
        saveOrder(payload).then((responde) => {
          toast.error(`Pedido enviado com sucesso! Nº${responde.data.id}`);
          setSelectedProducts([])
        })
          .catch(() => {
